...
SELECT DISTINCT last_name, COUNT(last_name) AS 'actors_name_count' FROM actor GROUP BY last_name;

-- 4b. List last names of actors and the number of actors who have that last name, but only for names that are shared by at least two actors
SELECT DISTINCT last_name, COUNT(last_name) AS 'actors_name_count' FROM actor GROUP BY last_name HAVING actors_name_count >= 2;
